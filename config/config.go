...
var (
	WebsiteConfig = map[string]int{
		...
		"UserBan":            0b0, //用户权限
		"SeekHelpBan":        0b0, //求助权限
		"LendHandBan":        0b0, //帮助权限
		"InitScore":          3,   //用户的初始分数
		"LoginDuration":      24,  //每次的登录时长,单位是小时
		"MaxUploadFileSize":  8,   //最大上传文件大小
		"MaxUploadImageSize": 8,   //最大上传图片大小
	}
)
...
// Verification code
const (
	SENDER_MAILBOX                = "helpthem@qq.com"
	SMTP_SERVER_PATH              = "smtp.qq.com"
	SMTP_SERVER_PORT              = 25 //":25"
	SMTP_SERVER_VERIFICATION_CODE = "xxx"
